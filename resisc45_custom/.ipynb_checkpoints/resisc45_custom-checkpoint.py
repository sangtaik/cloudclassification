...
class Resisc45Custom(tfds.core.GeneratorBasedBuilder):
  """NWPU Remote Sensing Image Scene Classification (RESISC) Dataset. 
  DatasetBuilder for resisc45_custom dataset."""
  ...
  def _split_generators(self, dl_manager):
    ...
    path = os.path.join(dl_manager.manual_dir, 'NWPU-RESISC45_CUSTOM')
